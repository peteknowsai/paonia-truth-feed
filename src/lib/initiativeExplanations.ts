import { InitiativeId } from '@/types/initiatives'

interface InitiativeExplanation {
  whatItDoes: string[]
  whyNeeded: {
    title: string
    description: string
...
const explanations: Record<InitiativeId, InitiativeExplanation> = {
  'str': {
    whatItDoes: [
    ...
    whyNeeded: [
      {
        title: "Voter Mandate Already Expressed",
        description: "On April 1, 2025, an overwhelming 70.4% of Paonia voters rejected the Town's restrictive STR ordinance. This wasn't a close vote - it was a landslide rejection of overregulation. Despite this clear mandate, the Town continues trying to restrict and extract fees from STRs. This initiative honors what voters already decided."
      },
      {
        title: "Protects Fundamental Property Rights",
        description: "Hosting guests in your own home is a basic property right. Whether it's family visiting for holidays, friends staying for a festival, or paying guests helping with the mortgage, what residents do in their principal residence shouldn't require government permission. The current ordinance treats a spare bedroom the same as a hotel - requiring ADA compliance, off-street parking, and expensive permits that make hosting economically impossible for regular residents."
      },
      {
        title: "Addresses Real Concerns About Investor STRs",
        description: "While protecting resident rights, this initiative acknowledges legitimate concerns about outside investors buying up housing stock. By prohibiting new investor STRs and phasing out single-family investor rentals by 2026, it strikes a balance. Multi-family and commercial properties can continue because they don't impact single-family neighborhood character."
      },
      {
        title: "Stops Fee Extraction",
        description: "The Town Clerk rejected this initiative claiming it \"establishes fees\" when it actually ELIMINATES them. This reveals their true concern: losing a revenue source. But STRs already pay state sales tax, county lodging taxes, and local taxes. If the Town genuinely needs additional revenue, they should ask voters - not block initiatives that eliminate fees."
      },
      {
        title: "Supports Local Economy",
        description: "Paonia depends on tourism. Resident-hosted STRs provide authentic local experiences that hotels can't match. Visitors stay in neighborhoods, shop locally, and often return. Killing STRs hurts small businesses that depend on tourist traffic."
      }
    ]
  },
  'email-transparency': {
    ...
    whyNeeded: [
      ...
      },
      {
        ...
        description: "This isn't burdensome - audit logs generate automatically. Microsoft 365, Google Workspace, and similar systems create these logs by default. The Town just needs to not delete them and provide them when requested. It's literally easier to comply than to obstruct."
      },
      {
        title: "Prevents 'Oops, We Deleted That' Excuses",
        description: "With mandatory three-year retention and criminal penalties for deletion, officials can't conveniently 'lose' records about controversial decisions. The audit log shows if someone deleted emails about the STR rejection, Brunner removal, or illegal executive sessions."
      },
      {
        title: "Standard Practice in Professional Organizations",
        description: "Any competent organization preserves audit logs for security, compliance, and troubleshooting. The Town's failure to maintain these basic records suggests either incompetence or deliberate obstruction. This initiative mandates professional standards."
      }
    ]
  },
  'executive-session': {
    ...
    whyNeeded: [
      {
        title: "June 10, 2025 Illegal Session Proves Need",
        description: "The Board held an executive session about 'Initiative Petitions' 15 days AFTER already rejecting the STR initiative. There's no legal basis for secret discussion of already-decided matters. This violates Colorado Open Meetings Law. Without recordings, we can't prove what they discussed or hold them accountable."
      },
      {
        title: "Pattern of Hiding Behind Executive Session",
        description: "Controversial decisions consistently involve executive sessions. The Brunner removal, STR rejection, surveillance expansion - all involve secret meetings. They're using executive session as a shield against public scrutiny, discussing matters that belong in public."
      },
      {
        title: "Vague Purpose Statements Hide True Discussions",
        description: "Currently, they announce 'personnel matters' or 'legal advice' without specifics. Which personnel? What legal issue? This initiative requires stating the PARTICULAR matter - if you're discussing the Smith lawsuit, say so. If it's about the Johnson contract, name it. Specificity prevents abuse."
      },
      {
        title: "Permanent Secrecy Enables Abuse",
        description: "Even though they record, there's no clear requirement for release. This initiative ensures recordings become public when the reason for secrecy ends. When the lawsuit settles, when the contract is signed, when the employee issue resolves - the public deserves to know what was discussed in their name."
      },
      {
        title: "Burden of Proof on Government",
        description: "Currently, citizens must prove improper use without access to evidence. This initiative flips that - the Town must prove executive sessions were proper. If they're following the law, this is easy. If not, they'll be exposed."
      }
    ]
  },
  'robot-moratorium': {
    ...
    whyNeeded: [
      {
        title: "Mysterious Deployment Without Notice",
        description: "In June 2025, autonomous robots suddenly appeared on Paonia streets. No public announcement. No explanation of their purpose. No identification of who operates them. No opportunity for citizen input. Residents discovered surveillance-capable technology roaming their neighborhoods without warning. This unilateral deployment demonstrates why we need democratic control over emerging technology."
      },
      {
        title: "Privacy and Surveillance Concerns",
        description: "These robots likely have cameras and sensors. Who operates them? What data do they collect? Where is it stored? Who has access? The timing is suspicious - robots appear just as the Town approves $50,000 in surveillance cameras and blocks citizen initiatives. Without transparency, we must assume the worst about surveillance capabilities."
      },
      {
        title: "Public Safety Issues",
        description: "Autonomous robots share sidewalks with children, elderly residents, and people with disabilities. What happens when a robot blocks a wheelchair? When a child chases one into traffic? When a dog attacks one defending its territory? Without safety protocols, accidents are inevitable."
      },
      {
        title: "Democratic Process Bypassed",
        description: "Major technology deployments affecting public spaces deserve public discussion. Instead, someone - we still don't know who - decided Paonia should have robots roaming its streets. This moratorium restores democratic control, forcing a pause until residents can weigh in."
      },
      {
        title: "Sets Precedent for Future Technology",
        description: "If we allow autonomous robots without public input, what's next? Facial recognition? Drone surveillance? By establishing that new technology requires democratic approval, we protect against future intrusions."
      }
    ]
  },
  'camera-ban': {
    ...
    whyNeeded: [
      {
        title: "Surveillance System Just Approved",
        description: "While claiming no resources for democratic processes, the Town found $50,000 for Verkada surveillance cameras. The system monitors Town Hall, the public park, and water facilities with cloud storage and remote access for police, public works, and the Town Administrator. This expansion happened without meaningful public input."
      },
      {
        title: "Privacy Rights in Small Towns Matter More",
        description: "In a city, you're anonymous. In Paonia, cameras record your daily patterns - when you walk your dog, who you meet for coffee, which meetings you attend. Government surveillance in a small town enables social control in ways that would be impossible in Denver. Everyone knows everyone - surveillance data becomes gossip, then leverage."
      },
      {
        title: "Chilling Effect on Democratic Participation",
        description: "Cameras at Town Hall and parks monitor who attends protests, who speaks at meetings, who associates with 'troublemakers.' The same Administrator who threatened resignation to force out an oversight-minded trustee now has camera access. Would you speak out knowing you're being watched and recorded?"
      },
      {
        title: "No Evidence Cameras Improve Safety",
        description: "Studies show surveillance cameras don't prevent crime - they just move it. Paonia doesn't have a crime wave requiring surveillance. This is about control, not safety. The Town wants to watch citizens while hiding its own activities in illegal executive sessions."
      },
      {
        title: "Cloud Storage Creates Permanent Records",
        description: "Verkada uses cloud storage - your movements become permanent records stored who-knows-where, accessible to who-knows-whom. Data breaches, government requests, employee abuse - once recorded, privacy is lost forever. Small town surveillance creates detailed dossiers on every resident."
      }
    ]
  },
  'trustee-protection': {
    ...
    whyNeeded: [
      {
        title: "Bill Brunner's Removal Shows the Danger",
        description: "Trustee Bill Brunner received 227 votes from citizens. He was removed by just 4 trustees (4-1 vote) - overturning the will of 227 voters with 4 votes. His 'crime'? Filing CORA requests, demanding transparency, and winning a lawsuit against the Town for violating open records law. He was doing exactly what voters elected him to do - provide oversight."
      },
      {
        title: "Administrator Manipulation Must Stop",
        description: "Town Administrator Stefen Wynn threatened to resign unless Brunner was removed. An unelected bureaucrat essentially forced elected officials to remove their colleague. This reverses democratic accountability - administrators work for elected officials, not vice versa. This initiative prevents such extortion."
      },
      {
        title: "Chilling Effect on All Trustees",
        description: "Every trustee now knows that asking tough questions, requesting records, or challenging staff could lead to removal. They've seen what happened to Brunner. This chills oversight and enables administrative abuse. When trustees fear removal, democracy fails."
      },
      {
        title: "Simple Majority Removal Is Anti-Democratic",
        description: "One trustee represents hundreds of voters. When 4 trustees can remove a fifth, they're disenfranchising those voters. Removal should be extraordinary, requiring overwhelming consensus or direct voter action - not simple majority politics."
      },
      {
        title: "Protects Minority Voices",
        description: "In any board, minority voices provide essential perspective. If the majority can simply remove dissenting trustees, boards become echo chambers. Democracy requires protecting unpopular opinions and uncomfortable questions."
      }
    ]
  }
}

export function getInitiativeExplanation(id: InitiativeId): InitiativeExplanation {
