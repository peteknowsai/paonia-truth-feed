...
| Clerk's Ground | Initiative Text | Response |
|---|---|---|
| Single-subject violation | One subject: prohibiting cameras | Structural provisions aren't separate subjects |
| Body-worn camera conflict with state law | Section 4(a) *exempts* body cams | An exemption is the opposite of regulation |
| "Administrative function" | Policy on surveillance of public spaces | Legislative policy, not administrative. Multiple cities have enacted similar legislation. |
| Contract provisions are "administrative" | Violating contracts are void | Standard enforcement mechanism |
