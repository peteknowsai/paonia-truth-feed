...
sources: [reporter-package-email-coverup, cora-libelous-communications, cora-c26-09-verkada-audit-logs, cora-c26-11-libelous-communications-response, cora-c26-12-m365-audit-logs-response, cora-c26-15-wynn-sent-emails-nov4-2024, cora-c26-30-verkada-poi-denial, pattern-of-cora-obstruction, board-letter-2026-03-30]
---
...
**Last updated: 2026-06-13 (Saturday)** — **The Verkada records were erased while two requests for them were pending.** Pete filed **C 26-30** (Person-of-Interest / People List + LPOI list + add/remove audit events) on **June 4** and **C 26-33** (Verkada audit-log continuation, the "next quarter" of the C 26-09 log) on **June 8**. The Clerk took **four days** to acknowledge C 26-30 (recv stamped June 8 vs. a next-business-day June 5). On **June 10** the Board voted unanimously to terminate Verkada and "all data was erased." On **June 11/12** both requests were answered with the **identical "no data exists to be searched"** letter — even though the Town's own [[cora-c26-09-verkada-audit-logs|C 26-09]] log (which Pete paid $167.90 for) proves the POI (`IDENTITY_PEOPLE_LIST_BULK_GET`) and LPOI (`LPOI_LIST`) lists existed. This happened ~4 weeks after Pete asked the Board, **on camera (May 12)**, not to delete the data "because [it] may be the subject of legal action." Full write-up: [[cora-c26-30-verkada-poi-denial]] / [[person-of-interest-list-erased]]; new **Pattern 9** below. Also: **C 26-29** (records behind the March 30 letter / March 31 Special Meeting — 8 items naming exact draft filenames/subjects/a Planner task from the Town's own M365) is **under extension to June 18, 2026**, no production yet; its April predecessor [[cora-c26-11-libelous-communications-response|C 26-11]] produced only 4 emails. Confirmed actual C-numbers (the May-31 "planned" numbering diverged): **C 26-26** = Wynn non-renewal communications (responded June 12, .eml bundle); **C 26-28** = Wynn "threat/safety" communications (responded June 11); **C 26-29** = March-30 letter records (extended June 18); **C 26-30** = Verkada POI/LPOI (DENIED, erased); **C 26-33** = Verkada audit-log continuation (DENIED, erased). Prior update — 2026-05-31 (Sunday): (1) **Draft audit correction:** C 26-25/26/27/28 were found to be **unsent Gmail drafts**, not filed requests — the prior "SENT May 29–30 / deadlines June 3–4" status was wrong; corrected throughout. C 26-28 is duplicated. CCJRA #2 was sent **May 31** (not May 30). (2) Added the C 26-11 incompleteness cross-check against the C 26-12 audit log (withheld drafts named, post-request deletions, audit-log production's own omitted windows), plus the drafted supplemental demand / Board letter / CFOIC request.
...
| **C 26-26** | 2026-05-28 (filed) | Communications re: Town Administrator (Wynn) **non-renewal** | **RESPONDED** 2026-06-12 | — | none stated | The actual number assigned to the May 28 non-renewal request (logged below as "likely C 26-24"). Produced as a large `.eml` bundle + redacted PDFs ("Notice of Intent Not to Renew," "Greg Sund Files," etc.). Not yet analyzed for completeness. |
| **C 26-28** | ~2026-06 (filed) | Wynn **"threat/safety" communications** (the Mar 12 "Meeker Resident," "Community Center Closure & Threat of Litigation," "Angry emails, maybe a threat?," No-Kings-rally "Fear for Safety" emails) | **RESPONDED** 2026-06-11 (after extension June 10) | — | none stated | The drafted "C 26-28" actually filed and answered. Produced the "threat/safety" email bodies + native .eml; centerpiece of the police-records narrative. See [[cora-c26-30-verkada-poi-denial]] context and the Sheree/Calla Rose police-records packages. |
| **C 26-29** | 2026-06-01 (filed June 2) | **Records behind the March 30 letter / March 31 Special Meeting** — 8 items: every draft/redline of the response letter + the Mayor's report, named email threads, and the "C 26-11 McCarthy -Flyer" Planner task — each identified by exact filename/subject from the Town's own M365 | **PRODUCED 2026-06-19** (one day after the extended deadline) | **June 18** (extension June 9/10; orig June 9) | $0 sought | The drill-down re-request after [[cora-c26-11-libelous-communications-response|C 26-11]] produced only 4 emails. Extension letter was emailed **June 10 — a day after the original June 9 deadline.** Production landed **June 19, 2026** — a day after the extended June 18 deadline: a 'C 26-29 Response' letter + the response-letter drafts (`Paige draft response to 10 things.docx` + `-LH`/`_sw` revisions) and Mayor's-report drafts, the records C 26-11 omitted. See [[cora-c26-29-march30-letter-drafts]]. Request: `raw/documents/cora-requests/cora-c26-29-march30-flyer-response-records.pdf`; extension: `raw/documents/cora-responses/C-26-29-Extension.pdf`. |
| **C 26-30** | 2026-06-04 (filed) | **Verkada Person of Interest / People List + License Plates of Interest (LPOI) list, + add/remove audit events Oct 22 2025→present** | **DENIED 2026-06-12 — records ERASED June 10 while pending** | June 11 (recv stamped June 8, 4 days after filing) | $0 | "No data exists to be searched." Town's own [[cora-c26-09-verkada-audit-logs|C 26-09]] log proves the lists existed (`IDENTITY_PEOPLE_LIST_BULK_GET`, `LPOI_LIST`). See [[cora-c26-30-verkada-poi-denial]] + **Pattern 9**. |
| **C 26-33** | 2026-06-08 (filed) | **Verkada Command audit-log continuation** — same export as C 26-09, Mar 26 2026 → present (the "next quarter" of the user-activity log) | **DENIED 2026-06-12 — records ERASED June 10 while pending** | June 17 (recv stamped June 12, 4 days after filing) | $0 | Acknowledged 8:00 AM June 12 ("deadline June 17") then **denied 11:36 PM the same day** with the identical erasure letter. See [[cora-c26-30-verkada-poi-denial]]. |

> **Numbering note (2026-06-13):** the May-31 "planned C 26-25/26/27/28" rows above describe *drafts*; the numbers the Town actually assigned diverged. As filed/answered: **C 26-26** = Wynn non-renewal; **C 26-28** = Wynn threat/safety; **C 26-29** = March-30-letter records; **C 26-30** = Verkada POI/LPOI; **C 26-33** = Verkada audit-log continuation. The "likely C 26-24" non-renewal entry below is the same request as C 26-26.
...
**Deletions after the request, and an omission in the audit-log production itself (added 2026-05-31):**

- **Post-request deletions.** The same C 26-12 audit log records several of these responsive items moved to Deleted Items *after* C 26-11 was filed (April 6) — including three in the Clerk's own (`samirav`) mailbox within ~25 minutes on **April 21, the day the Clerk certified the production complete and closed the request**: `Re: draft "letter from Trustee"` (3:28 PM), `Being Handed Out In Town by McCarthy` (3:50 PM), and the draft Mayor's report (3:53 PM); the draft Mayor's report was also moved to Deleted Items in the `paiges` mailbox on April 23. *(Caveat: `MoveToDeletedItems` moves an item to the Deleted Items folder — ordinarily recoverable, not permanent destruction. The timing is the point, not proven destruction.)*
- **The audit-log production omitted the windows that matter.** The original C 26-12 production (April 22) was missing all of true March 2026 (a duplicate of April 1–9 was supplied in March's place) and all of April after the 9th (every monthly file capped at exactly 50,000 rows; April's volume filled the cap by the 9th). The complete logs arrived only in the May 27 cure, after objection. Those two omitted windows — late March and late April — are exactly where the withheld letter drafts (above) and the April 21 deletions live. The Town attributes this to an export error.
- **Acted on 2026-05-31:** a supplemental/reopen demand to the custodian (§ 204(3)/(4) produce-or-justify + § 204(5) 14-day notice + litigation-hold demand; `raw/documents/cora-requests/cora-c26-11-supplemental-demand.md`), a letter to the Board (`raw/documents/board-complaint/letter-2026-05-31-c26-11-withholding.md`), and a CFOIC hotline request (`raw/documents/cfoic/letter-2026-05-31-paonia-cora.md`). The criminal frame raised for review is abuse of records, C.R.S. § 18-8-114. All drafted in Gmail; not yet sent as of 2026-05-31.
...
- **Update (2026-06-13)**: this request was assigned **C 26-26** and **responded June 12, 2026** as a large `.eml` bundle plus redacted PDFs ("FW: Notice of Intent Not to Renew," "Greg Sund Files," "Sharing the Town of Paonia's latest town…"). Completeness not yet audited.

### 2026-06-01 — CORA C 26-29 — Records behind the March 30 letter / March 31 Special Meeting — **PRODUCED 2026-06-19**

- **Filed**: form dated 2026-06-01; emailed Tuesday **2026-06-02, 1:00 PM**. Gmail thread `19e86d6dc55ac6cb`.
- **Acknowledged**: 2026-06-04 (Thu) by [[samira-vetter|Vetter]] — *"received today June 4, 2026 and the deadline is June 9, 2026."*
- **Extension**: letter dated June 9, **emailed June 10, 00:49** (i.e. *after* the original June 9 deadline had already run) — 7-working-day extension under § 24-72-203(3)(b)(II)/(III); **new deadline June 18, 2026** (`raw/documents/cora-responses/C-26-29-Extension.pdf`).
- **Status as of 2026-06-13**: **No production yet.** The extended deadline (June 18) has not passed; the *original* 3-day deadline (June 9) did. *(Note: an earlier recollection had this deadline as already passed — the extension moved it to **June 18**, so it is not technically late yet, but nothing has been produced and the extension itself arrived a day late.)*
- **Subject (8 items)**, each identified by exact filename/subject from the Town's **own** Microsoft 365 records (`raw/documents/cora-requests/cora-c26-29-march30-flyer-response-records.pdf`):
  1. Every draft/revised/tracked-changes version of the Board's March 30 response letter — incl. `Paige draft response to 10 things_sw.docx` (ed. 3/28) and `Revised Letter to Paonia Citizens Approved for posting by the Trustees on 3.30.2026.docx` (3/31) — with M365/SharePoint/OneDrive version history. (3/25–4/1.)
  2. Every draft of the **Mayor's report for the March 30 Special Meeting**, incl. the file attached to "PLease see the attached drafft Mayor's report for the Special Meeting." (3/27–30.)
  3. Emails titled `draft "letter from Trustee"` (3/27–28; Smith/Wynn/Vetter mailboxes).
  4. Emails titled "Being Handed Out In Town by McCarthy" (3/24–4/1).
  5. Emails titled "Response to the Citizen's 10 things flyer . I Need comments /no later than 2:00 tomorrow" (3/28–31).
  6. Emails titled "Revised Letter to Town of Paonia Citizens including the agreed upon changes approved by the BoT at the 3.30.2026 Special Meeting" (3/31–4/1).
  7. The email "Town is holding a Special Meeting tomorrow at 6:30 to set the record straight" (Mayor Smith, 3/29).
  8. The Microsoft Planner task **"C 26-11 McCarthy -Flyer"** + full comment/activity history (Town's records show comment activity Apr 9–May 1, 2026, tied to the Clerk and ClerkOperations Planner).
- **Significance**: the surgical re-request after [[cora-c26-11-libelous-communications-response|C 26-11]] produced only four emails (two of them Pete's own) and no drafts, tracked changes, or trustee-to-trustee comms for the same six-day window. Each item here is named from the Town's own audit log, so a § 204(3) non-existence certification is largely foreclosed. **This is the "March 30/31 letter" request to watch — June 18.**
- **Source**: thread `19e86d6dc55ac6cb`; see also [[cora-c26-11-libelous-communications-response]].

### 2026-06-04 / 06-08 — CORA C 26-30 & C 26-33 — Verkada POI/LPOI lists + audit-log continuation — **DENIED (RECORDS ERASED WHILE PENDING)**

- **C 26-30 filed**: Thursday **2026-06-04, 8:00 AM** (form dated 6/2). POI/People List + LPOI list (current native exports) **and** the add/remove audit events for both, Oct 22 2025 → date processed. Thread `19e919f5274919dd`.
- **C 26-33 filed**: Monday **2026-06-08, 8:00 AM** (form dated 5/29). Verkada Command user-activity log, Mar 26 2026 → date processed — the direct continuation of [[cora-c26-09-verkada-audit-logs|C 26-09]]. Thread `19e77476c75d3eda`.
- **Acknowledgment delay**: C 26-30 was filed June 4 but the Clerk stamped it **received June 8** (deadline June 11) — four days, where the Town's own policy deems a request received the *next business day* (Fri June 5). C 26-33 (filed June 8) was likewise stamped **received June 12** (deadline June 17) — four days.
- **The erasure**: **2026-06-10**, the Board voted unanimously to terminate Verkada; cameras off; per the Town, **"all data was erased"** — while both requests were live.
- **The denials**: **2026-06-11/12**, both answered with the **identical** letter — *"all data was erased … there are no responsive records … no data exists to be searched."* C 26-33 was even acknowledged ("deadline June 17") and denied the **same day** (8:00 AM ack, 11:36 PM denial). `raw/documents/cora-responses/C-26-30-Response.pdf`, `raw/documents/cora-responses/C-26-33-Response.pdf`.
- **Why the denial is false**: the Town's own C 26-09 audit log (produced & billed $167.90, April 8) carries an `event_type` column with `IDENTITY_PEOPLE_LIST_BULK_GET` and `LPOI_LIST` — the POI and LPOI lists demonstrably existed and were logged from "installation (October 22, 2025) to present." The records existed when filed (June 4/8) and when acknowledged (June 8); they were destroyed June 10.
- **Preservation posture**: triple notice before June 10 — (1) on **May 12, 2026**, in public comment **on camera**, Pete named the Verkada audit log and the Persons of Interest list and asked the Board, on any termination vote, to *"Direct that no Verkada-stored footage be deleted between now and the completion of an independent audit"* — and, as delivered, *"that you preserve for the record and you do not delete the archives … because they may be the subject of … legal action"* (`raw/documents/public-comments/2026-05-12-speech-deck.html` + `…-as-delivered.txt`; meeting video is primary); (2) the requests were *pending* when destroyed (June 8 acknowledgment = written notice to the custodian); (3) a standing written litigation-hold demand covering "audit log records" since May 5/14. They were told out loud not to delete it, then deleted it.
- **Full write-up**: [[cora-c26-30-verkada-poi-denial]] and the story [[person-of-interest-list-erased]]. **Pattern 9** below.
...
### Pattern 9: Destroy-the-record-then-deny (records erased while the request is pending)

This is the most serious pattern on the docket, and it is new (June 2026). On **C 26-30** (Person-of-Interest / People List + LPOI list + add/remove audit events) and **C 26-33** (the Verkada audit-log continuation), the Town did not slow-walk, over-redact, or redirect — it **destroyed the underlying records while the requests were pending and then certified there was nothing to find.**

The sequence is documented to the day, and the Board was warned: at the **May 12, 2026** regular meeting, in public comment **on camera**, Pete named the Verkada audit log and Persons of Interest list and asked the trustees that any termination vote *"Direct that no Verkada-stored footage be deleted between now and the completion of an independent audit"* — and, as delivered, *"that you preserve for the record and you do not delete the archives … because they may be the subject of … legal action."* Then Pete filed C 26-30 on **June 4** and C 26-33 on **June 8**; the Clerk **acknowledged C 26-30 in writing on June 8** (so the custodian had actual notice); on **June 10** the Board voted unanimously to terminate Verkada and "all data was erased"; on **June 11/12** both requests drew the identical *"no data exists to be searched"* letter. The records' existence is not in doubt — the Town's **own** [[cora-c26-09-verkada-audit-logs|C 26-09]] production (which it billed $167.90 for) names the very lists (`IDENTITY_PEOPLE_LIST_BULK_GET`, `LPOI_LIST`) and logged them continuously from October 22, 2025.

Unlike Patterns 6 and 8 (incomplete or adjacent production, curable under pressure), Pattern 9 is **not curable** — once the data is gone, no follow-up can produce it. It converts a records dispute into a **records-destruction / spoliation** question under CORA, Colorado records-retention law (C.R.S. § 24-80-101 et seq.), and common-law spoliation. It also casts the four-day acknowledgment delays (Pattern 4, here at its most consequential) in a darker light: the clock-stretching put the "no records" letter on the far side of the June 10 vote. Full analysis: [[cora-c26-30-verkada-poi-denial]]; story: [[person-of-interest-list-erased]].

*(One technical caveat preserved for honesty: the Verkada **Command** audit log and list membership are cloud-side org data, not camera video; "turning off the cameras" does not necessarily erase the Command org's audit trail, and the vendor may retain backups. Whether the data is truly irretrievable is itself worth pressing — the Town's flat "all data was erased" should not be taken at face value.)*

## Open Items as of 2026-06-13

| Request | Action Required | Notes |
|---|---|---|
| **C 26-30 / C 26-33 (Verkada POI/LPOI + audit-log continuation)** | **Escalate the destruction** — records erased June 10 while pending | DENIED as "no data exists." Decide CFOIC complaint / § 204(5) notice / district court, and press Verkada-the-vendor on whether the Command audit log is actually irretrievable. See [[cora-c26-30-verkada-poi-denial]]. |
| **C 26-29 (March-30-letter records, extended)** | **PRODUCED June 19, 2026 (one day late)** | 22 attachments incl. the response-letter and Mayor's-report drafts C 26-11 omitted. See [[cora-c26-29-march30-letter-drafts]]. |
| C 26-26 (Wynn non-renewal, responded June 12) | **Audit the .eml production for completeness** | Large .eml bundle + redacted PDFs delivered; not yet checked against the audit log the way C 26-11 was. |
...
|---|---|---|---|
| Police records re complaints concerning Stefen Wynn | 2026-05-28 | **PRODUCED 2026-06-04** | Filed alongside the May 28 CORA non-renewal request. Acknowledged same day by Chief Matt Laiminger. $50 fee threshold noticed (he will notify before exceeding it). CCJRA has no fixed 3-day clock (§ 24-72-305). Pete set an in-person meeting with Laiminger for June 1. **Produced 2026-06-04**: 10 PDFs across 8 case files (one withheld as active). See [[ccjra-pd-records-2026-06-04]]. |
| **CCJRA #2** — PD "Bullying and Harassment on Social Media in Advance of 500-600 Political Activists…Rally" thread (Laiminger ↔ Officer Henderson), plus the "No Kings Rally…Fear for Safety…with my Image" thread to the extent in PD custody | 2026-05-31 (sent) | **PRODUCED 2026-06-18** | Confirmed sent **2026-05-31 (17:23 MDT)** — corrected from an earlier "May 30" note — subject "…PD communications re: flyer / social-media harassment" — covers the Henderson bullying thread, the No Kings rally thread, and any PD records framing the flyer/posts as bullying/harassment/threat, Mar 24–Apr 30 2026, each as the full thread. $50 fee threshold noticed. CCJRA has no fixed clock. **Produced 2026-06-18** by JoAnn Katzer: the March 28 protection-order email (Wynn to Laiminger) + the March 26 'Fear for Safety' email and four read receipts; the Clerk reported no emails found on the 'Ten Things' flyer. See [[ccjra-nokings-rally-2026-06-18]]. |
...
- [[cora-c26-30-verkada-poi-denial]] — The Person-of-Interest list erased while the request was pending (Pattern 9)
- [[person-of-interest-list-erased]] — The narrative story of the erasure
