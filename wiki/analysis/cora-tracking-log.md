...
| **C 26-29** | 2026-06-01 (filed June 2) | **Records behind the March 30 letter / March 31 Special Meeting** — 8 items: every draft/redline of the response letter + the Mayor's report, named email threads, and the "C 26-11 McCarthy -Flyer" Planner task — each identified by exact filename/subject from the Town's own M365 | **PENDING — EXTENDED to June 18, 2026** | **June 18** (extension June 9/10; orig June 9) | $0 sought | The drill-down re-request after [[cora-c26-11-libelous-communications-response|C 26-11]] produced only 4 emails. Extension letter was emailed **June 10 — a day after the original June 9 deadline.** No production yet as of June 13. Request: `raw/documents/cora-requests/cora-c26-29-march30-flyer-response-records.pdf`; extension: `raw/documents/cora-responses/C-26-29-Extension.pdf`. |
...
### 2026-06-01 — CORA C 26-29 — Records behind the March 30 letter / March 31 Special Meeting — **PENDING (EXTENDED to June 18)**
...
| **C 26-29 (March-30-letter records, extended)** | **Watch June 18, 2026** | 8 items named from the Town's own M365; no production yet. If June 18 passes with nothing or another thin C-26-11-style production, escalate. |
